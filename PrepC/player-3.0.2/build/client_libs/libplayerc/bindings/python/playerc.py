...
class player_boolprop_req_t(_object):
    ...
    if _newclass:key_count = _swig_property(_playerc.player_boolprop_req_t_key_count_get, _playerc.player_boolprop_req_t_key_count_set)
    ...
    if _newclass:key = _swig_property(_playerc.player_boolprop_req_t_key_get, _playerc.player_boolprop_req_t_key_set)
    ...
    if _newclass:value = _swig_property(_playerc.player_boolprop_req_t_value_get, _playerc.player_boolprop_req_t_value_set)
    def __init__(self): 
...
class player_laser_data_scanangle_t(_object):
    ...
    if _newclass:max_range = _swig_property(_playerc.player_laser_data_scanangle_t_max_range_get, _playerc.player_laser_data_scanangle_t_max_range_set)
    ...
    if _newclass:ranges_count = _swig_property(_playerc.player_laser_data_scanangle_t_ranges_count_get, _playerc.player_laser_data_scanangle_t_ranges_count_set)
    ...
    if _newclass:ranges = _swig_property(_playerc.player_laser_data_scanangle_t_ranges_get, _playerc.player_laser_data_scanangle_t_ranges_set)
    ...
    if _newclass:angles_count = _swig_property(_playerc.player_laser_data_scanangle_t_angles_count_get, _playerc.player_laser_data_scanangle_t_angles_count_set)
    ...
    if _newclass:angles = _swig_property(_playerc.player_laser_data_scanangle_t_angles_get, _playerc.player_laser_data_scanangle_t_angles_set)
    ...
    if _newclass:intensity_count = _swig_property(_playerc.player_laser_data_scanangle_t_intensity_count_get, _playerc.player_laser_data_scanangle_t_intensity_count_set)
    ...
    if _newclass:intensity = _swig_property(_playerc.player_laser_data_scanangle_t_intensity_get, _playerc.player_laser_data_scanangle_t_intensity_set)
    ...
    if _newclass:id = _swig_property(_playerc.player_laser_data_scanangle_t_id_get, _playerc.player_laser_data_scanangle_t_id_set)
    def __init__(self): 
...
class player_simulation_property_req_t(_object):
    ...
    if _newclass:index = _swig_property(_playerc.player_simulation_property_req_t_index_get, _playerc.player_simulation_property_req_t_index_set)
...
class player_joystick_data_t(_object):
    ...
    if _newclass:axes_count = _swig_property(_playerc.player_joystick_data_t_axes_count_get, _playerc.player_joystick_data_t_axes_count_set)
    def __init__(self): 
...
class player_imu_data_fullstate_t(_object):
    ...
    if _newclass:pose = _swig_property(_playerc.player_imu_data_fullstate_t_pose_get, _playerc.player_imu_data_fullstate_t_pose_set)
    ...
    if _newclass:vel = _swig_property(_playerc.player_imu_data_fullstate_t_vel_get, _playerc.player_imu_data_fullstate_t_vel_set)
    ...
    if _newclass:acc = _swig_property(_playerc.player_imu_data_fullstate_t_acc_get, _playerc.player_imu_data_fullstate_t_acc_set)
    def __init__(self): 
...
class player_ranger_config_t(_object):
    ...
    if _newclass:angular_res = _swig_property(_playerc.player_ranger_config_t_angular_res_get, _playerc.player_ranger_config_t_angular_res_set)
    ...
    if _newclass:min_range = _swig_property(_playerc.player_ranger_config_t_min_range_get, _playerc.player_ranger_config_t_min_range_set)
...
class player_ranger_geom_t(_object):
    ...
    if _newclass:element_poses_count = _swig_property(_playerc.player_ranger_geom_t_element_poses_count_get, _playerc.player_ranger_geom_t_element_poses_count_set)
    ...
    if _newclass:element_poses = _swig_property(_playerc.player_ranger_geom_t_element_poses_get, _playerc.player_ranger_geom_t_element_poses_set)
    ...
    if _newclass:element_sizes_count = _swig_property(_playerc.player_ranger_geom_t_element_sizes_count_get, _playerc.player_ranger_geom_t_element_sizes_count_set)
    ...
    if _newclass:element_sizes = _swig_property(_playerc.player_ranger_geom_t_element_sizes_get, _playerc.player_ranger_geom_t_element_sizes_set)
    def __init__(self): 
...
class player_ranger_data_rangestamped_t(_object):
    ...
    if _newclass:data = _swig_property(_playerc.player_ranger_data_rangestamped_t_data_get, _playerc.player_ranger_data_rangestamped_t_data_set)
    ...
    if _newclass:have_geom = _swig_property(_playerc.player_ranger_data_rangestamped_t_have_geom_get, _playerc.player_ranger_data_rangestamped_t_have_geom_set)
    ...
    if _newclass:geom = _swig_property(_playerc.player_ranger_data_rangestamped_t_geom_get, _playerc.player_ranger_data_rangestamped_t_geom_set)
    ...
    if _newclass:have_config = _swig_property(_playerc.player_ranger_data_rangestamped_t_have_config_get, _playerc.player_ranger_data_rangestamped_t_have_config_set)
    ...
    if _newclass:config = _swig_property(_playerc.player_ranger_data_rangestamped_t_config_get, _playerc.player_ranger_data_rangestamped_t_config_set)
    def __init__(self): 
...
class player_ranger_data_intnsstamped_t(_object):
    ...
    if _newclass:data = _swig_property(_playerc.player_ranger_data_intnsstamped_t_data_get, _playerc.player_ranger_data_intnsstamped_t_data_set)
    ...
    if _newclass:have_geom = _swig_property(_playerc.player_ranger_data_intnsstamped_t_have_geom_get, _playerc.player_ranger_data_intnsstamped_t_have_geom_set)
    ...
    if _newclass:geom = _swig_property(_playerc.player_ranger_data_intnsstamped_t_geom_get, _playerc.player_ranger_data_intnsstamped_t_geom_set)
    ...
    if _newclass:have_config = _swig_property(_playerc.player_ranger_data_intnsstamped_t_have_config_get, _playerc.player_ranger_data_intnsstamped_t_have_config_set)
    ...
    if _newclass:config = _swig_property(_playerc.player_ranger_data_intnsstamped_t_config_get, _playerc.player_ranger_data_intnsstamped_t_config_set)
    def __init__(self): 
...
class player_pointcloud3d_stereo_element_t(_object):
    ...
    if _newclass:px = _swig_property(_playerc.player_pointcloud3d_stereo_element_t_px_get, _playerc.player_pointcloud3d_stereo_element_t_px_set)
    ...
    if _newclass:py = _swig_property(_playerc.player_pointcloud3d_stereo_element_t_py_get, _playerc.player_pointcloud3d_stereo_element_t_py_set)
    ...
    if _newclass:pz = _swig_property(_playerc.player_pointcloud3d_stereo_element_t_pz_get, _playerc.player_pointcloud3d_stereo_element_t_pz_set)
    ...
    if _newclass:red = _swig_property(_playerc.player_pointcloud3d_stereo_element_t_red_get, _playerc.player_pointcloud3d_stereo_element_t_red_set)
    ...
    if _newclass:green = _swig_property(_playerc.player_pointcloud3d_stereo_element_t_green_get, _playerc.player_pointcloud3d_stereo_element_t_green_set)
    ...
    if _newclass:blue = _swig_property(_playerc.player_pointcloud3d_stereo_element_t_blue_get, _playerc.player_pointcloud3d_stereo_element_t_blue_set)
    def __init__(self): 
...
class player_stereo_data_t(_object):
    ...
    if _newclass:left_channel = _swig_property(_playerc.player_stereo_data_t_left_channel_get, _playerc.player_stereo_data_t_left_channel_set)
    ...
    if _newclass:right_channel = _swig_property(_playerc.player_stereo_data_t_right_channel_get, _playerc.player_stereo_data_t_right_channel_set)
    ...
    if _newclass:disparity = _swig_property(_playerc.player_stereo_data_t_disparity_get, _playerc.player_stereo_data_t_disparity_set)
    ...
    if _newclass:points_count = _swig_property(_playerc.player_stereo_data_t_points_count_get, _playerc.player_stereo_data_t_points_count_set)
    ...
    if _newclass:points = _swig_property(_playerc.player_stereo_data_t_points_get, _playerc.player_stereo_data_t_points_set)
    ...
    if _newclass:mode = _swig_property(_playerc.player_stereo_data_t_mode_get, _playerc.player_stereo_data_t_mode_set)
    def __init__(self): 
...
class intArray(_object):
    ...
    if _newclass:actual = _swig_property(_playerc.intArray_actual_get, _playerc.intArray_actual_set)
    def __getitem__(self, *args): return _playerc.intArray___getitem__(self, *args)
    def __setitem__(self, *args): return _playerc.intArray___setitem__(self, *args)
    def __init__(self): 
...
class doubleArray(_object):
    ...
    if _newclass:actual = _swig_property(_playerc.doubleArray_actual_get, _playerc.doubleArray_actual_set)
    def __getitem__(self, *args): return _playerc.doubleArray___getitem__(self, *args)
    def __setitem__(self, *args): return _playerc.doubleArray___setitem__(self, *args)
    def __init__(self): 
...
class floatArray(_object):
    ...
    if _newclass:actual = _swig_property(_playerc.floatArray_actual_get, _playerc.floatArray_actual_set)
    def __getitem__(self, *args): return _playerc.floatArray___getitem__(self, *args)
    def __setitem__(self, *args): return _playerc.floatArray___setitem__(self, *args)
    def __init__(self): 
...
class playerc_client_item(_object):
    ...
    if _newclass:header = _swig_property(_playerc.playerc_client_item_header_get, _playerc.playerc_client_item_header_set)
    ...
    if _newclass:data = _swig_property(_playerc.playerc_client_item_data_get, _playerc.playerc_client_item_data_set)
    def __init__(self): 
...
class playerc_device_info(_object):
    ...
    if _newclass:addr = _swig_property(_playerc.playerc_device_info_addr_get, _playerc.playerc_device_info_addr_set)
    ...
    if _newclass:drivername = _swig_property(_playerc.playerc_device_info_drivername_get, _playerc.playerc_device_info_drivername_set)
    def __init__(self): 
...
class playerc_client(_object):
    ...
    if _newclass:connected = _swig_property(_playerc.playerc_client_connected_get, _playerc.playerc_client_connected_set)
...
class playerc_device(_object):
    ...
    if _newclass:id = _swig_property(_playerc.playerc_device_id_get, _playerc.playerc_device_id_set)
    ...
    if _newclass:client = _swig_property(_playerc.playerc_device_client_get, _playerc.playerc_device_client_set)
    __swig_setmethods__["addr"] = _playerc.playerc_device_addr_set
    __swig_getmethods__["addr"] = _playerc.playerc_device_addr_get
    if _newclass:addr = _swig_property(_playerc.playerc_device_addr_get, _playerc.playerc_device_addr_set)
    ...
    if _newclass:drivername = _swig_property(_playerc.playerc_device_drivername_get, _playerc.playerc_device_drivername_set)
    ...
    if _newclass:subscribed = _swig_property(_playerc.playerc_device_subscribed_get, _playerc.playerc_device_subscribed_set)
    ...
    if _newclass:datatime = _swig_property(_playerc.playerc_device_datatime_get, _playerc.playerc_device_datatime_set)
    ...
    if _newclass:lasttime = _swig_property(_playerc.playerc_device_lasttime_get, _playerc.playerc_device_lasttime_set)
    __swig_setmethods__["fresh"] = _playerc.playerc_device_fresh_set
    __swig_getmethods__["fresh"] = _playerc.playerc_device_fresh_get
    if _newclass:fresh = _swig_property(_playerc.playerc_device_fresh_get, _playerc.playerc_device_fresh_set)
    ...
    if _newclass:freshgeom = _swig_property(_playerc.playerc_device_freshgeom_get, _playerc.playerc_device_freshgeom_set)
    ...
    if _newclass:freshconfig = _swig_property(_playerc.playerc_device_freshconfig_get, _playerc.playerc_device_freshconfig_set)
    ...
    if _newclass:putmsg = _swig_property(_playerc.playerc_device_putmsg_get, _playerc.playerc_device_putmsg_set)
    ...
    if _newclass:user_data = _swig_property(_playerc.playerc_device_user_data_get, _playerc.playerc_device_user_data_set)
    ...
    if _newclass:callback_count = _swig_property(_playerc.playerc_device_callback_count_get, _playerc.playerc_device_callback_count_set)
    ...
    if _newclass:callback = _swig_property(_playerc.playerc_device_callback_get, _playerc.playerc_device_callback_set)
    ...
    if _newclass:callback_data = _swig_property(_playerc.playerc_device_callback_data_get, _playerc.playerc_device_callback_data_set)
    def init(self, *args): return _playerc.playerc_device_init(self, *args)
    def term(self): return _playerc.playerc_device_term(self)
    def subscribe(self, *args): return _playerc.playerc_device_subscribe(self, *args)
    def unsubscribe(self): return _playerc.playerc_device_unsubscribe(self)
    def hascapability(self, *args): return _playerc.playerc_device_hascapability(self, *args)
    def get_boolprop(self, *args): return _playerc.playerc_device_get_boolprop(self, *args)
    def set_boolprop(self, *args): return _playerc.playerc_device_set_boolprop(self, *args)
    def get_intprop(self, *args): return _playerc.playerc_device_get_intprop(self, *args)
    def set_intprop(self, *args): return _playerc.playerc_device_set_intprop(self, *args)
    def get_dblprop(self, *args): return _playerc.playerc_device_get_dblprop(self, *args)
    def set_dblprop(self, *args): return _playerc.playerc_device_set_dblprop(self, *args)
    def get_strprop(self, *args): return _playerc.playerc_device_get_strprop(self, *args)
    def set_strprop(self, *args): return _playerc.playerc_device_set_strprop(self, *args)
    def __init__(self): 
...
class playerc_joystick(_object):
    ...
    if _newclass:info = _swig_property(_playerc.playerc_joystick_info_get, _playerc.playerc_joystick_info_set)
    ...
    if _newclass:axes_count = _swig_property(_playerc.playerc_joystick_axes_count_get, _playerc.playerc_joystick_axes_count_set)
    __swig_setmethods__["pos"] = _playerc.playerc_joystick_pos_set
    __swig_getmethods__["pos"] = _playerc.playerc_joystick_pos_get
    if _newclass:pos = _swig_property(_playerc.playerc_joystick_pos_get, _playerc.playerc_joystick_pos_set)
    ...
    if _newclass:buttons = _swig_property(_playerc.playerc_joystick_buttons_get, _playerc.playerc_joystick_buttons_set)
    ...
    if _newclass:axes_max = _swig_property(_playerc.playerc_joystick_axes_max_get, _playerc.playerc_joystick_axes_max_set)
    ...
    if _newclass:axes_min = _swig_property(_playerc.playerc_joystick_axes_min_get, _playerc.playerc_joystick_axes_min_set)
    ...
    if _newclass:scale_pos = _swig_property(_playerc.playerc_joystick_scale_pos_get, _playerc.playerc_joystick_scale_pos_set)
    def __init__(self, *args): 
        this = _playerc.new_playerc_joystick(*args)
        try: self.this.append(this)
        except: self.this = this
    def destroy(self): return _playerc.playerc_joystick_destroy(self)
    def subscribe(self, *args): return _playerc.playerc_joystick_subscribe(self, *args)
    def unsubscribe(self): return _playerc.playerc_joystick_unsubscribe(self)
...
class playerc_localize_particle(_object):
    ...
    if _newclass:pose = _swig_property(_playerc.playerc_localize_particle_pose_get, _playerc.playerc_localize_particle_pose_set)
    ...
    if _newclass:weight = _swig_property(_playerc.playerc_localize_particle_weight_get, _playerc.playerc_localize_particle_weight_set)
    def __init__(self): 
...
class playerc_vectormap(_object):
    ...
    if _newclass:wkbprocessor = _swig_property(_playerc.playerc_vectormap_wkbprocessor_get, _playerc.playerc_vectormap_wkbprocessor_set)
    def __init__(self, *args): 
    ...
    def get_feature_data_count(self, *args): return _playerc.playerc_vectormap_get_feature_data_count(self, *args)
...
class playerc_position2d(_object):
    ...
    def set_cmd_vel_head(self, *args): return _playerc.playerc_position2d_set_cmd_vel_head(self, *args)
...
class playerc_ranger(_object):
    ...
    if _newclass:element_count = _swig_property(_playerc.playerc_ranger_element_count_get, _playerc.playerc_ranger_element_count_set)
    ...
    if _newclass:angular_res = _swig_property(_playerc.playerc_ranger_angular_res_get, _playerc.playerc_ranger_angular_res_set)
    ...
    if _newclass:min_range = _swig_property(_playerc.playerc_ranger_min_range_get, _playerc.playerc_ranger_min_range_set)
    ...
    if _newclass:element_poses = _swig_property(_playerc.playerc_ranger_element_poses_get, _playerc.playerc_ranger_element_poses_set)
    ...
    if _newclass:element_sizes = _swig_property(_playerc.playerc_ranger_element_sizes_get, _playerc.playerc_ranger_element_sizes_set)
...
class playerc_wifi_link(_object):
    ...
    if _newclass:mac = _swig_property(_playerc.playerc_wifi_link_mac_get, _playerc.playerc_wifi_link_mac_set)
    __swig_setmethods__["ip"] = _playerc.playerc_wifi_link_ip_set
    __swig_getmethods__["ip"] = _playerc.playerc_wifi_link_ip_get
    if _newclass:ip = _swig_property(_playerc.playerc_wifi_link_ip_get, _playerc.playerc_wifi_link_ip_set)
    ...
    if _newclass:essid = _swig_property(_playerc.playerc_wifi_link_essid_get, _playerc.playerc_wifi_link_essid_set)
    __swig_setmethods__["mode"] = _playerc.playerc_wifi_link_mode_set
    __swig_getmethods__["mode"] = _playerc.playerc_wifi_link_mode_get
    if _newclass:mode = _swig_property(_playerc.playerc_wifi_link_mode_get, _playerc.playerc_wifi_link_mode_set)
    ...
    if _newclass:encrypt = _swig_property(_playerc.playerc_wifi_link_encrypt_get, _playerc.playerc_wifi_link_encrypt_set)
    __swig_setmethods__["freq"] = _playerc.playerc_wifi_link_freq_set
    __swig_getmethods__["freq"] = _playerc.playerc_wifi_link_freq_get
    if _newclass:freq = _swig_property(_playerc.playerc_wifi_link_freq_get, _playerc.playerc_wifi_link_freq_set)
    __swig_setmethods__["qual"] = _playerc.playerc_wifi_link_qual_set
    __swig_getmethods__["qual"] = _playerc.playerc_wifi_link_qual_get
    if _newclass:qual = _swig_property(_playerc.playerc_wifi_link_qual_get, _playerc.playerc_wifi_link_qual_set)
    ...
    if _newclass:level = _swig_property(_playerc.playerc_wifi_link_level_get, _playerc.playerc_wifi_link_level_set)
    ...
    if _newclass:noise = _swig_property(_playerc.playerc_wifi_link_noise_get, _playerc.playerc_wifi_link_noise_set)
    def __init__(self): 
...
class playerc_simulation(_object):
    ...
    def pause(self): return _playerc.playerc_simulation_pause(self)
    def reset(self): return _playerc.playerc_simulation_reset(self)
    def save(self): return _playerc.playerc_simulation_save(self)
...
class playerc_rfidtag(_object):
    ...
    if _newclass:type = _swig_property(_playerc.playerc_rfidtag_type_get, _playerc.playerc_rfidtag_type_set)
    ...
    if _newclass:guid_count = _swig_property(_playerc.playerc_rfidtag_guid_count_get, _playerc.playerc_rfidtag_guid_count_set)
    __swig_setmethods__["guid"] = _playerc.playerc_rfidtag_guid_set
    __swig_getmethods__["guid"] = _playerc.playerc_rfidtag_guid_get
    if _newclass:guid = _swig_property(_playerc.playerc_rfidtag_guid_get, _playerc.playerc_rfidtag_guid_set)
    def __init__(self): 
...
class playerc_stereo(_object):
    ...
    if _newclass:info = _swig_property(_playerc.playerc_stereo_info_get, _playerc.playerc_stereo_info_set)
    ...
    if _newclass:left_channel = _swig_property(_playerc.playerc_stereo_left_channel_get, _playerc.playerc_stereo_left_channel_set)
    ...
    if _newclass:right_channel = _swig_property(_playerc.playerc_stereo_right_channel_get, _playerc.playerc_stereo_right_channel_set)
    ...
    if _newclass:disparity = _swig_property(_playerc.playerc_stereo_disparity_get, _playerc.playerc_stereo_disparity_set)
    ...
    if _newclass:points_count = _swig_property(_playerc.playerc_stereo_points_count_get, _playerc.playerc_stereo_points_count_set)
    ...
    if _newclass:points = _swig_property(_playerc.playerc_stereo_points_get, _playerc.playerc_stereo_points_set)
    def __init__(self, *args): 
        this = _playerc.new_playerc_stereo(*args)
        try: self.this.append(this)
        except: self.this = this
    def destroy(self): return _playerc.playerc_stereo_destroy(self)
    def subscribe(self, *args): return _playerc.playerc_stereo_subscribe(self, *args)
    def unsubscribe(self): return _playerc.playerc_stereo_unsubscribe(self)
...
class playerc_imu(_object):
    ...
    if _newclass:vel = _swig_property(_playerc.playerc_imu_vel_get, _playerc.playerc_imu_vel_set)
    __swig_setmethods__["acc"] = _playerc.playerc_imu_acc_set
    __swig_getmethods__["acc"] = _playerc.playerc_imu_acc_get
    if _newclass:acc = _swig_property(_playerc.playerc_imu_acc_get, _playerc.playerc_imu_acc_set)
